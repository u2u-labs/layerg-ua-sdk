...
import { EntryPointSimulations__factory, IPaymaster__factory } from '@layerg-ua-sdk/aa-smc/typechain-types'
...
const decodeRevertReasonContracts = new Interface([
  ...new Interface(EntryPointSimulations__factory.abi).fragments,
  ...new Interface(IPaymaster__factory.abi).fragments,
  ...new Interface(SimpleAccount__factory.abi).fragments,
